...
function encodeToRot13(str) {
  ...
  for (let i = 0; i < str.length; i += 1) {
    if ((str[i].charCodeAt() < 78 && str[i].charCodeAt() >= 65)
      || (str[i].charCodeAt() < 110 && str[i].charCodeAt() >= 97)) {
      str2 += String.fromCharCode(str[i].charCodeAt() + 13);
    } else if ((str[i].charCodeAt() < 91 && str[i].charCodeAt() >= 78)
      || (str[i].charCodeAt() < 123 && str[i].charCodeAt() >= 110)) {
      str2 += String.fromCharCode(str[i].charCodeAt() - 13);
    } else {
      str2 += str[i];
    }
...
function isString(value) {
  const res = value instanceof String || typeof value === 'string';
  return res;
}
